...
import { View, Text, StyleSheet, ScrollView, RefreshControl, FlatList, ViewStyle, TextStyle, ActivityIndicator } from 'react-native';
  ...
  return (
    ...
    >
      ...
      <View style={styles.sectionHeader as ViewStyle}>
        ...
        <Text style={styles.viewAll as TextStyle} onPress={() => router.push('/(restaurant)/(tabs)/orders')}>View All</Text>
      </View>

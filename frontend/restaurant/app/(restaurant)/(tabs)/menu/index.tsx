        ...
        <View style={styles.itemInfo as ViewStyle}>
          ...
          <View style={styles.itemActions as ViewStyle}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => router.push(`/(restaurant)/menu/item/${item.id}`)}
            >
    ...
    <View style={globalStyles.container as ViewStyle}>
      <View style={styles.header as ViewStyle}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => router.push('/(restaurant)/menu/item/new')}
        >
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer as ViewStyle}>
            ...
            <TouchableOpacity style={styles.emptyAddButton} onPress={() => router.push('/(restaurant)/menu/item/new')}>
